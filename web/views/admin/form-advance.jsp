...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../node_modules/mohithg-switchery/dist/switchery.min.css">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="profile.jsp"><i class="ik ik-user dropdown-icon"></i> Profile</a>
                                    <a class="dropdown-item" href="#"><i class="ik ik-settings dropdown-icon"></i> Settings</a>
                                    <a class="dropdown-item" href="#"><span class="float-right"><span class="badge badge-primary">6</span></span><i class="ik ik-mail dropdown-icon"></i> Inbox</a>
                                    <a class="dropdown-item" href="#"><i class="ik ik-navigation dropdown-icon"></i> Message</a>
                                    <a class="dropdown-item" href="login.jsp"><i class="ik ik-power dropdown-icon"></i> Logout</a>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="navbar.jsp"><i class="ik ik-menu"></i><span>Navigation</span> <span class="badge badge-success">New</span></a>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Widgets</span> <span class="badge badge-danger">150+</span></a>
                                    <div class="submenu-content">
                                        <a href="widgets.jsp" class="menu-item">Basic</a>
                                        <a href="widget-statistic.jsp" class="menu-item">Statistic</a>
                                        <a href="widget-data.jsp" class="menu-item">Data</a>
                                        <a href="widget-chart.jsp" class="menu-item">Chart Widget</a>
                                    </div>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="ui/alerts.jsp" class="menu-item">Alerts</a>
                                        <a href="ui/badges.jsp" class="menu-item">Badges</a>
                                        <a href="ui/buttons.jsp" class="menu-item">Buttons</a>
                                        <a href="ui/navigation.jsp" class="menu-item">Navigation</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-gitlab"></i><span>Advance</span> <span class="badge badge-success">New</span></a>
                                    <div class="submenu-content">
                                        <a href="ui/modals.jsp" class="menu-item">Modals</a>
                                        <a href="ui/notifications.jsp" class="menu-item">Notifications</a>
                                        <a href="ui/carousel.jsp" class="menu-item">Slider</a>
                                        <a href="ui/range-slider.jsp" class="menu-item">Range Slider</a>
                                        <a href="ui/rating.jsp" class="menu-item">Rating</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-package"></i><span>Extra</span></a>
                                    <div class="submenu-content">
                                        <a href="ui/session-timeout.jsp" class="menu-item">Session Timeout</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="ui/icons.jsp"><i class="ik ik-command"></i><span>Icons</span></a>
                                </div>
                                <div class="nav-lavel">Forms</div>
                                <div class="nav-item has-sub active open">
                                    <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>
                                    <div class="submenu-content">
                                        <a href="form-components.jsp" class="menu-item">Components</a>
                                        <a href="form-addon.jsp" class="menu-item">Add-On</a>
                                        <a href="form-advance.jsp" class="menu-item active">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="form-picker.jsp"><i class="ik ik-terminal"></i><span>Form Picker</span> <span class="badge badge-success">New</span></a>
                                </div>

                                <div class="nav-lavel">Tables</div>
                                <div class="nav-item">
                                    <a href="table-bootstrap.jsp"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="table-datatable.jsp"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="charts-chartist.jsp" class="menu-item">Chartist</a>
                                        <a href="charts-flot.jsp" class="menu-item">Flot</a>
                                        <a href="charts-knob.jsp" class="menu-item">Knob</a>
                                        <a href="charts-amcharts.jsp" class="menu-item">Amcharts</a>
                                    </div>
                                </div>

                                <div class="nav-lavel">Apps</div>
                                <div class="nav-item">
                                    <a href="calendar.jsp"><i class="ik ik-calendar"></i><span>Calendar</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="taskboard.jsp"><i class="ik ik-server"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="register.jsp" class="menu-item">Register</a>
                                        <a href="forgot-password.jsp" class="menu-item">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-file-text"></i><span>Other</span></a>
                                    <div class="submenu-content">
                                        <a href="profile.jsp" class="menu-item">Profile</a>
                                        <a href="invoice.jsp" class="menu-item">Invoice</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="layouts.jsp"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                                </div>
