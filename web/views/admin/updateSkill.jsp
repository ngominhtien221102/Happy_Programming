                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<%=request.getContextPath()%>/updateSkill">
                                            <div class="form-group">
                                                <label >Skill's Name</label>
                                                <input type="text" class="form-control" name="name" 
                                                       required placeholder="Skill's name" value="${requestScope.oldName}">
                                            </div>

                                            <button type="submit" class="btn btn-primary mr-2" value="update">Update</button>
                                            <button class="btn btn-light"><a href="views/user/skills.jsp">Cancel</a></button>
