<%-- 
    Document   : charts-chartist
    Created on : Sep 27, 2022, 12:30:04 AM
    Author     : Lenovo
--%>
                            ...
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="form-advance.jsp" class="menu-item">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                ...
                                <div class="nav-item has-sub active open">
                                    ...
                                    <div class="submenu-content">
                                        <a href="charts-chartist.jsp" class="menu-item active">Chartist</a>
