                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">CreateSkill</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<%=request.getContextPath()%>/createSkill">
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Skill's Name</label>
                                                <input type="text" class="form-control" name="name" 
                                                       required placeholder="Skill's name">
                                            </div>
