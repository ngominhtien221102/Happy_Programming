<%-- 
    Document   : index
    Created on : Sep 27, 2022, 12:41:13 AM
    Author     : Lenovo
--%>
                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="pages/profile.jsp"><i class="ik ik-user dropdown-icon"></i> Profile</a>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="pages/table-datatable.jsp"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="pages/charts-chartist.jsp" class="menu-item active">Chartist</a>
