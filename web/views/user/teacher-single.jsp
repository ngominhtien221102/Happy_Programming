<%-- 
    Document   : teacher-single
    Created on : Sep 21, 2022, 3:36:08 PM
    Author     : Lenovo
--%>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <ul class="list-inline custom-breadcrumb">
                            <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="teacher.jsp">Our Teacher</a></li>
