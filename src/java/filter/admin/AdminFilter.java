...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (roleId != 4){
            ...
            if (url.endsWith("allInvitation.jsp")){
                res.sendRedirect(req.getContextPath() + "/allInvitation");
            }
            
            //view all mentee page
            if (url.endsWith("allMentee.jsp")){
                res.sendRedirect(req.getContextPath() + "/allMentee");
            }
