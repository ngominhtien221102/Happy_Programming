 ...
 * @author Admin
 */
@WebFilter(filterName = "UpdateProfileFilter", urlPatterns = {"/updateProfile", "/views/user/updateMenteeProfile.jsp"})
public class UpdateProfileFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("UpdateProfileFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("UpdateProfileFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (roleId > 1) {
            if (roleId != 2) {
                ...
                if (url.endsWith(".jsp")) {
                    res.sendRedirect(req.getContextPath() + "/updateProfile");
                }
            }
        }
        if (debug) {
            log("UpdateProfileFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("UpdateProfileFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("UpdateProfileFilter(");
