 ...
 * @author Admin
 */
@WebFilter(filterName = "ViewProfileFilter", urlPatterns = {"/viewMenteeProfile", "/views/user/menteeProfile.jsp"})
public class ViewProfileFilter implements Filter {
    ...
    public ViewProfileFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ViewProfileFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ViewProfileFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //3. Nếu mentee chưa tạo profile thì sẽ nhảy tới trang create profile
        ...
        if (roleId > 1) {
            if (roleId != 2) {
                ...
                if (url.endsWith(".jsp")) {
                    res.sendRedirect(req.getContextPath() + "/viewMenteeProfile");
                }
            }
        }

        if (debug) {
            log("ViewProfileFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("ViewProfileFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ViewProfileFilter()");
        }
        StringBuffer sb = new StringBuffer("ViewProfileFilter(");
