 ...
 * @author Admin
 */
@WebFilter(filterName = "ViewRequestFilter", urlPatterns = {"/viewAllRequest", "/views/user/viewRequest.jsp"})
public class ViewRequestFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("ViewRequestFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ViewRequestFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (roleId ==1 && roleId == 4){
            ...
            if (url.endsWith(".jsp")){
                res.sendRedirect(req.getContextPath() + "/viewAllRequest");
            }
        }
        if (debug) {
            log("ViewRequestFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("ViewRequestFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ViewRequestFilter()");
        }
        StringBuffer sb = new StringBuffer("ViewRequestFilter(");
